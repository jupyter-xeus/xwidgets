...
namespace xw
{
    ...
    // USEFUL MACROS (most of them have been found here: https://github.com/pfultz2/Cloak/wiki/C-Preprocessor-tricks,-tips,-and-idioms)
    ...
    #define PASS_PARAMETERS(X) STRIP_PARENS( EXPAND X )
    ...
    //
    // XPRECOMPILE(EXTERN, (xslider), (int, double)) returns
    //
